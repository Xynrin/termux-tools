...
ORANGE='\e[38;5;202m'; GOLD='\e[38;5;214m'; YELLOW='\e[38;5;226m'
GREEN='\e[32m'; CYAN='\e[36m'; BLUE='\e[34m'; BOLD='\e[1m'; RESET='\e[0m'
...
if ! command -v curl &> /dev/null; then
    echo "正在安装 curl... / Installing curl..."
    pkg install -y curl
fi

# 克隆 / 更新仓库 / Clone or update repo
...
# install.sh 内部会下 Rust 二进制并 exec xynrin --bootstrap
# install.sh will fetch the Rust binary and exec xynrin --bootstrap
echo ""
